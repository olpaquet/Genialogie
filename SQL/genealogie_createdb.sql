...
/***TABLES*/
 ...
 create unique index iu_arbre_nom on Arbre(nom)
...
create PROCEDURE utilisateur_cre
 @id int out, @login nvarchar(100), @nom nvarchar(100), @prenom nvarchar(100), @email nvarchar(400), @datedenaissance datetime, @homme int, @cartedepayement nvarchar(50), @motdepasse nvarchar(50), @presel nvarchar(510), @postsel nvarchar(510)
AS
...
@id int,@nom nvarchar(100),@prenom nvarchar(100),@email nvarchar(400),@datedenaissance datetime,@homme int, @cartedepayement nvarchar(50)
AS
update utilisateur
set nom=@nom,prenom=@prenom,email=@email,datedenaissance=@datedenaissance,homme=@homme, cartedepayement=@cartedepayement
where id=@id
;
go
...
/************SETUP******/
declare @id int
exec utilisateur_cre @id out, 'admin','admin',null,'adm@i.n',null,1,null,'1','presel','postsel'
